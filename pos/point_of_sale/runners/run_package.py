...
actions = {'singup': partial(test_methods.sign_up_trans_web),
           ...
           'one_click_services': partial(test_methods.signup_oc, 'ws', config.test_data['eticket'], config.test_data),
           'oneclick_pos_all': partial(test_methods.signup_oc_all, 'pos', config.test_data['eticket'],
                                       config.test_data),  # iterrate all pricpoints in 1 click to all pricepoints
