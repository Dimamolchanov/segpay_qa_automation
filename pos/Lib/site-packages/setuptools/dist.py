...
class Distribution(Distribution_parse_config_files, _Distribution):
    """Distribution with support for utils, tests, and package data
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'utils' **deprecated** -- a dictionary mapping option names to
        'setuptools.Feature'
        objects.  Features are a portion of the distribution that can be
        included or excluded based on user options, inter-feature dependencies,
        and availability on the current system.  Excluded utils are omitted
    ...
    distribution for the included and excluded utils.
    """
    ...
    def __init__(self, attrs=None):
        ...
        if not have_package_data:
            self.package_data = {}
        attrs = attrs or {}
        if 'utils' in attrs or 'require_features' in attrs:
    ...
    def parse_command_line(self):
        """Process utils after parsing command line options"""
    ...
    def _set_global_opts_from_features(self):
        """Add --with-X/--without-X options based on optional utils"""
    ...
    def _finalize_features(self):
        """Add/remove utils and resolve dependencies between them"""
        ...
        # Then disable the rest, so that off-by-default utils don't
...
class Feature:
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    Features are created using these keyword arguments:
      ...
      'require_features' -- a string or sequence of strings naming utils
      ...
      'remove' -- a string or list of strings naming packages to be removed
         ...
         to support removing utils that "crosscut" a distribution, such as
         defining a 'tests' feature that removes all the 'tests' subpackages
         provided by other utils.  The default for this argument is an empty
    ...
    def exclude_from(self, dist):
        ...
        feature, and only after all included utils have been asked to
        include themselves.
        """
